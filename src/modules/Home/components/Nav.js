  ...
  return (
    <NavContent>
      <div className="row">
        ...
        <div className="col-8 d-flex align-items-center justify-content-center">
          {/* <Tabs defaultActiveKey="1">
            <TabPane tab="Chổ ở" key="1">
              <NavFilter>
                <SearchBox listActive={data} playholder="chọn điểm đến" />
          ...
          >
            ...
            >
              <Tab label="Chổ ở " {...a11yProps(0)} />
              <Tab label="Trải nghiệm" {...a11yProps(1)} />
              <Tab
                label={
                  <button
      ...
      <div className="d-flex justify-content-center">
        ...
        <TabPanel value={value} index={1}>
          <NavFilter>
            <SearchBox listActive={data} placeholder="chọn điểm đến" />
            <DatePicker onChange={onChange3} placeholder="ngày đến" />
            <DatePicker onChange={onChange4} placeholder="ngày đi" />
            <div className="person-number">
              <input type="text" placeholder="số người" />
